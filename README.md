...
1.2013/10/02
	...
	4. employees表のename列、sal列、sal列に100000を足したものを12倍した列<br />
を取り出すスクリプト(141002-4.sql)2013/10/02
	1. employees表のempno列、ename列を取り出すスクリプト(141002.-1.sl)
	2. employees表のすべての列を取り出すスクリプト(141002-2.sql)
	3. employees表のひょう構造を表示するスクリプト(141002-3.sql)
	4. employees表のename列、sal列、sal列に100000を足したものを12倍した列<br />
を取り出すスクリプト(141002-4.sql)
